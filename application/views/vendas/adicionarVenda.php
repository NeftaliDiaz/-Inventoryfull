            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalles de salida</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Datos incompletos, verifique los campos com asteriscos selecionados corretamente personal y responsable.</div>
                                <?php } ?>
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span2">
                                            <label for="dataInicial">Fecha de Salida<span class="required">*</span></label>
