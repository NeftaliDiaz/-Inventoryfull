            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalles de la Salida</a></li>
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span8 offset2" style="text-align: center">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/vendas/visualizar/<?php echo $result->idVendas; ?>" class="btn btn-inverse"><i class="icon-eye-open"></i> Visualizar Salida</a>
