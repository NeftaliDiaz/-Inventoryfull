<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aVenda')){ ?>
    <a href="<?php echo base_url();?>index.php/vendas/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Agregar Salida</a>
<?php } ?>
...
<table class="table table-bordered ">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="6">Ninguna salida Registrada</td>
        </tr>
    </tbody>
</table>
</div>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h5 id="myModalLabel">Eliminar Salidas</h5>
  </div>
  <div class="modal-body">
    <input type="hidden" id="idVenda" name="id" value="" />
    <h5 style="text-align: center">Desea realmente eliminar esta Salida?</h5>
  </div>
