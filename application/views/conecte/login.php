...
<head>
        <title>RMA/OS</title><meta charset="UTF-8" />
        ...
        <div id="loginbox">            
            <form  class="form-vertical" id="formLogin" method="post" action="<?php echo base_url()?>index.php/conecte/login">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-star"></i></span><input name="telefone" type="text" placeholder="Teléfono | Ex: 9999-9999" />
                        </div>
                    </div>
                </div>
           <div class="control-group normal_text"> <h5>Para poder acceder utilice los siguientes datos:</h5>
           <h5>E-mail: prueba@prueba.com</h5>
           <h5>Teléfono: 555555</h5>
