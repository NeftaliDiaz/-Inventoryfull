            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalles de la Requisición</a></li>
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <h3>#Requisición: <?php echo $result->idOs ?></h3>
                                        
                                        <div class="span6" style="margin-left: 0">
                                            <label for="cliente">personal<span class="required">*</span></label>
                                            <input id="cliente" class="span12" type="text" name="cliente" value="<?php echo $result->nomeCliente ?>"  />
                                            <input id="clientes_id" class="span12" type="hidden" name="clientes_id" value="<?php echo $result->clientes_id ?>"  />
                                            <input id="valorTotal" type="hidden" name="valorTotal" value=""  />
                                        </div>
                                        <div class="span6">
                                            <label for="tecnico">Responsablel<span class="required">*</span></label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="status" id="status" value="">
                                                <option <?php if($result->status == 'Cancelada'){echo 'selected';} ?> value="Cancelada">PrCancelada</option>
                                                <option <?php if($result->status == 'Colocada'){echo 'selected';} ?> value="Colocada">Colocada</option>
                                                <option <?php if($result->status == 'Cotizada'){echo 'selected';} ?> value="Cotizada">Cotizada</option>
                                                <option <?php if($result->status == 'En proceso de Autorización'){echo 'selected';} ?> value="En proceso de Autorización">En proceso de Autorización</option>
                                                <option <?php if($result->status == 'No autorizada'){echo 'selected';} ?> value="No autorizada">No autorizada</option>
                                                <option <?php if($result->status == 'Pendiente de Pago'){echo 'selected';} ?> value="Pendiente de Pago">Pendiente de Pago</option>
                                                <option <?php if($result->status == 'Revisión'){echo 'selected';} ?> value="Revisión">Revisión</option>
                                            </select>
                                        </div>                                            
                                        <div class="span3">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span6">
                                            <label for="laudoTecnico">Diagnóstico </label>
        ...
        $("#formAnexos").validate({
          ...
          submitHandler: function( form ){       
                ...
                $.ajax({
                  ...
                  error : function() {
                      $("#divAnexos").html('<div class="alert alert-danger fade in"><button type="button" class="close" data-dismiss="alert">×</button><strong>Atenção!</strong> Ocurrio un error. Verifique los adjunto o(s) arquivo(s).</div>');      
                  }
