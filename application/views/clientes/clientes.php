<?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aCliente')){ ?>
    <a href="<?php echo base_url();?>index.php/clientes/adicionar" class="btn btn-success"><i class="icon-plus icon-white"></i> Agregar Personal</a>    
<?php } ?>
...
if(!$results){?>
        ...
        <div class="widget-content nopadding">
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        <td colspan="5">Ningún Personal Registrado</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h5 id="myModalLabel">Eliminar Personal</h5>
  </div>
  <div class="modal-body">
    <input type="hidden" id="idCliente" name="id" value="" />
    <h5 style="text-align: center">¿Realmente deseas eliminar este personal y los datos asociados con él (OS, ventas, ingresos)?</h5>
  </div>
