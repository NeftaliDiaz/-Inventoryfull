    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content ">
                <div class="alert alert-danger">Ningún datos se ha registrado hasta la fecha. Esta información estará disponible en la pantalla de impresión OS.</div>
...
<div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">RMA/OS - Registrar Datos de la Empresa</h3>
  </div>
...
<div id="modalAlterar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">RMA/OS - Editar Datos de la Empresa</h3>
  </div>
  <div class="modal-body">
...
<div id="modalLogo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">Modificar Dirección</h3>
  </div>
  <div class="modal-body">
         <div class="span12 alert alert-info">Selecione uma nueva imagem de logomarca. Tamanño indicado (130 X 130).</div>          
         <div class="control-group">
            <label for="logo" class="control-label"><span class="required">Logomarca*</span></label>
            <div class="controls">
                <input type="file" name="userfile" value="" />
