...
class Mapos extends CI_Controller {
    ...
    public function verificarLogin(){
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($ajax == true){
                ...
                $this->session->set_flashdata('error','Os datos de acceso son incorrecos.');
                redirect($this->login);
            }
        } 
        else {
            ...
            if(count($usuario) > 0){
                ...
                if($ajax == true){
                    ...
                    $this->session->set_flashdata('error','Os datos de acceso son incorrectos.');
                    redirect($this->login);
                }
            }
    ...
    public function backup(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){
           $this->session->set_flashdata('error','No tiene permiso para efectuar backup.');
           redirect(base_url());
        }
    ...
    public function emitente(){   
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){
           $this->session->set_flashdata('error','No tiene permiso para configurar la empresa.');
           redirect(base_url());
        }
    ...
    public function editarEmitente() {
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){
           $this->session->set_flashdata('error','Usted no está autorizado a configurar la empresa.');
           redirect(base_url());
        }
