...
class Relatorios extends CI_Controller{
    ...
    public function clientes(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rCliente')){
           $this->session->set_flashdata('error','No se le permite generar informes de clientes.');
           redirect(base_url());
        }
    ...
    public function produtos(){
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rProduto')){
           $this->session->set_flashdata('error','No se le permite generar informes de productos.');
           redirect(base_url());
        }
    ...
    public function clientesCustom(){
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rCliente')){
           $this->session->set_flashdata('error','No se le permite generar informes de personal.');
           redirect(base_url());
        }
    ...
    public function servicos(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rServico')){
           $this->session->set_flashdata('error','No se le permite generar informes de servicios.');
           redirect(base_url());
        }
    ...
    public function os(){
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rOs')){
           $this->session->set_flashdata('error','No se le permite generar informes de OS.');
           redirect(base_url());
        }
    ...
    public function financeiro(){
        ...
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rFinanceiro')){
           $this->session->set_flashdata('error','No se le permite generar informes financieros.');
           redirect(base_url());
        }
    ...
    public function vendas(){
        if(!$this->permission->checkPermission($this->session->userdata('permissao'),'rVenda')){
           $this->session->set_flashdata('error','No se le permite generar informes de ventas.');
           redirect(base_url());
        }
